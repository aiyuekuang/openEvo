...
import type { SkillRequirements, SkillInstallOption, SkillOpenClawMetadata } from "./skill-metadata.js";
 ...
 * 快速检测技能是否就绪
 */
export function isSkillReady(requires: SkillRequirements | undefined, metadata?: SkillOpenClawMetadata): boolean {
...
export function getRequiredAction(
  requires: SkillRequirements | undefined,
  metadata?: SkillOpenClawMetadata
): "ready" | "needs_install" | "needs_config" | "unsupported" {
  const result = checkDependencies(requires, metadata);
