...
// OpenClaw CN: 移除海外渠道类型定义
// 已移除: discord, slack, telegram, signal, imessage, whatsapp, line
...
export type PluginRuntime = {
  ...
  channel: {
    ...
    // OpenClaw CN: 中国渠道将通过插件注册
    // 海外渠道已移除: discord, slack, telegram, signal, imessage, whatsapp, line
  };
  logging: {
