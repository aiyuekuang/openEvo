...
// OpenClaw CN: 移除海外渠道 config schema 导出
// 保留 GoogleChat 和 MSTeams (可能有用)
export {
...
// OpenClaw CN: 移除海外渠道 group mentions 导出
export {
...
// OpenClaw CN: 移除所有海外渠道导出
// 已移除: Discord, iMessage, Slack, Telegram, Signal, WhatsApp, BlueBubbles, LINE
